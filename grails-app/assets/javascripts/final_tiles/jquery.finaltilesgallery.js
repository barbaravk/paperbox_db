...
(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        setMaxTileWidth : function () {
            this.maxTileWidth = Math.floor(this.currentWidth * this.settings.maxTileWidthFactor - this.settings.margin)
            this.print("maxTileWidth: " + this.maxTileWidth)
        },
            ...
            switch ($item.get(0).tagName.toLowerCase()) {
                case "img":
                    ...
                    img.onload = function () {
                        ...
                        var maxWidth = instance.maxTileWidth;
                        ...
                        if(instance.settings.layout == "final") {
                            ...
                            if (size.width > maxWidth) {
                                size.height = Math.floor(size.height * (maxWidth / size.width));
                                size.width = maxWidth
                            }
                        }
