...
!function( $ ) {
	...
	var Datepicker = function(element, options){
		...
		if (this.element.data('start-date')) {
			this.setViewDate(this.element.data('start-date'))
		};
	...
	Datepicker.prototype = {
		...
		setViewDate: function(newDate){
			var tempDate = DPGlobal.parseDate(newDate, this.format);
			this.viewDate = new Date(tempDate.getFullYear(), tempDate.getMonth(), 1, 0, 0, 0, 0);
			this.fill();
		},
		
		update: function(newDate){
			this.date = DPGlobal.parseDate(
				typeof newDate === 'string' ? newDate : (this.isInput ? this.element.prop('value') : this.element.data('start-date')),
				this.format
			);
			this.viewDate = new Date(this.date.getFullYear(), this.date.getMonth(), 1, 0, 0, 0, 0);
			this.fill();
