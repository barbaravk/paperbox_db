...
+function ($) {
    ...
    var Validator = function (element, options) {
        ...
        this.$element.on('input.bs.validator focusout.bs.validator', Validator.INPUT_SELECTOR, $.proxy(this.onInput, this))
    ...
    Validator.INPUT_SELECTOR = ':input:not([type="submit"]):enabled'

    Validator.FOCUS_OFFSET = 0
    ...
    Validator.VALIDATORS = {
        ...
        'password': function ($el) {
            var pw = $el.val()
            return !$el.val() || pw.length < $el.data('minlength') || (pw.match(/[A-z]/) && pw.match(/[A-Z]/) && pw.match(/\d/))
        },
        'dateval': function ($el) {
            var val = $el.val()
